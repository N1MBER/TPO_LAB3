...
//    }
    ...
    @Test
    public void checkCommunityTarget() {
        actions.moveToElement(mainPage.getCommunityButton()).perform();
        String title = mainPage.getCurrentCommunity().getText();
        mainPage.getCurrentCommunity().click();
        String current = mainPage.getCommunityTitle().getText();
