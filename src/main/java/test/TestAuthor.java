...
//    }
    ...
    @Test
    public void checkAuthorTarget() {
        actions.moveToElement(mainPage.getAuthorButton()).perform();
        String title = mainPage.getCurrentAuthor().getText();
        mainPage.getCurrentAuthor().click();
        String current = mainPage.getAuthorTitle().getText();
